...
/**
 * Simple implementation of a data store using Google AppEngine persistent Datastore
 */
public final class DeviceDatastore {
	...
	private static final Logger logger = Logger.getLogger(DeviceDatastore.class
			.getName());
