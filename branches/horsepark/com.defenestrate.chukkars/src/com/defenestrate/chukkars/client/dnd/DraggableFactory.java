...
public class DraggableFactory {
   ...
   *
   * @param dragController the drag controller
   * @param label the label for the red box widget
   * @return the new widget
   */
  public static Widget createDraggableRedBox(DragController dragController, String label) {
    Widget redBox = new RedBoxDraggableWidget(label);
